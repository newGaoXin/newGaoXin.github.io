...
<img src="https://cdn.nlark.com/yuque/0/2021/png/22368000/1630588034352-256119c1-e14f-4295-946f-87817c357889.png" alt="二叉排序树" style="zoom:80%;" />
...
<img src="https://cdn.nlark.com/yuque/0/2021/png/22368000/1630588089633-f9e47773-d508-4ab5-96fe-d150ddef2847.png" alt="对应的二叉排序树" style="zoom:80%;" />
...
第二种情况: 删除只有一颗子树的节点 比如 1
    ...
    (5) 如果 targetNode 有左子结点
    	5. 1 如果 targetNode 是 parent 的左子结
...
```java
    /**
     * 以传进来的左节点为根节点，向右边节点遍历找到最大值
     *
     * @param leftNode
     * @return
     */
    public int deleteLeftTreeNode(Node leftNode) {

        // 向右遍历找到最大值
        Node targe = leftNode;
        if (targe.getRight() != null) {
            targe = targe.getRight();
        }

        // 删除最大值的节点
        delete(targe.getValue());
