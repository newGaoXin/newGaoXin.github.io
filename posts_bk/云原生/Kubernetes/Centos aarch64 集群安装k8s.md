...
#所有机器配置master域名 设置自己的地址
echo "172.16.164.100  k8s-master" >> /etc/hosts
```
...
```bash
kubeadm init \
--apiserver-advertise-address=172.16.164.100 \ # 对应master ip地址
...
![Snipaste_2023-03-22_16-18-42](./Centos aarch64 集群安装k8s images/Snipaste_2023-03-22_16-18-42.png)
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        # docker 上找的支持 arm64 的景象
        image: rancher/metrics-server:v0.4.1-arm64
